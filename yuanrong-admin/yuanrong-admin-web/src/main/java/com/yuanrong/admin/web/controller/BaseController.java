...
public class BaseController extends AllController {
     ...
     * @return
     */
    public UserInfo getWebUser(HttpSession httpSession) {
        UserInfo userInfo = JSONObject.toJavaObject((JSONObject) httpSession.getAttribute("userInfoJSON") , UserInfo.class);
        return userInfo;
    }

    public UserInfo getWebUser() {
        UserInfo userInfo = JSONObject.toJavaObject((JSONObject) session.getAttribute("userInfoJSON") , UserInfo.class);
        return userInfo;
    }
