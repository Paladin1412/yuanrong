package com.yuanrong.admin.web.interceptor;
...
public class ExceptionResolver implements HandlerExceptionResolver {
    ...
    public ModelAndView resolveException(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o, Exception e) {
        ...
        if(httpServletRequest.getServerName().contains("yuanrongbank.com")
            ...
            wechatServicesI.sendBugToEngineer(EnumWeChartType.bug ,bugInfo.getDomain() , content,"", configurationServicesI.getbyKey(SystemParam.BUG_SERVER_URL)+"/bug/ex_bugInfo_getbyId?bugInfoId="+bugInfo.getBugInfoId());
        }
