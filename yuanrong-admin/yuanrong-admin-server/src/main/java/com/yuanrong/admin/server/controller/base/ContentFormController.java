...
public class ContentFormController extends BaseController {
     ...
     * @return
     */
    @RequestMapping( value = "exs_contentFormList")
    @ResponseBody
    ...
    @RequestMapping( value = "contentForm_saveOk" , method = RequestMethod.POST)
    @ResponseBody
    public ResultTemplate saveOk(ContentForm theContentForm){
        contentFormServicesI.save(theContentForm);
