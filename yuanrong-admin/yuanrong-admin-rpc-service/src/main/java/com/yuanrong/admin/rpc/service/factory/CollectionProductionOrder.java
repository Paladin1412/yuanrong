 ...
 */
public class CollectionProductionOrder extends OrderModel{
    public OrderInfoBuyer createOrder() {
        ...
        YRProduction production = yRProductionDaoI.getById(orderInfoSeller.getReferId());
        //未发布作品
        ...
        theOrderInfoBuyer.setEnumOrderSellerType(EnumOrderSellerType.原创征稿);
        ...
        theOrderInfoBuyer.setSaleUserId(theOrderInfoBuyer.getSaleUserId());

        //买家服务费率
        theOrderInfoBuyer.setBuyerServiceRate(orderInfoSeller.getInvoiceRate());
        ...
        sellerOrder.setEnumOrderSellerType(EnumOrderSellerType.原创征稿);
        ...
        //存储卖家服务费
        BigDecimal sellerServicesFeePercent = orderInfoSeller.getSellerServiceRate().divide(new BigDecimal("100"));
