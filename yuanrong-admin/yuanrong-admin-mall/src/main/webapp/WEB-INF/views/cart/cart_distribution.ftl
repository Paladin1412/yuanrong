<#include "../commonFragments/basic/meta.ftl"/>
	<title>选购车_营销账号_圆融内容交易服务中心</title>
...
<div class="wrap">
	<div class="cart-wrap">
		...
		<div class="cart-list-con-wrap">
			...
			<ul class="cart-sub-tab-wrap fixedClear" id="js-cart-dis-tab-wrap">
				<li data-id="" class="active tab-dis-all">全部</li>
				<li data-id="1" class="tab-wx"><i class="iconfont icon-weixin-copy" style="margin-right: 4px;"></i>微信(<span class="" id="js-cart-wx-num"></span>)</li>
				<li data-id="2" class="tab-wb"><i class="iconfont icon-weibo1" style="margin-right: 4px;"></i>微博(<span class="" id="js-cart-wb-num"></span>)</li>
				<li data-id="3" class="tab-sv"><i class="iconfont icon-shipinbofang" style="margin-right: 4px;"></i>短视频(<span class="" id="js-cart-sv-num"></span>)</li>
			</ul>
			<div class="cart-distribution-wrap">
				<!-- 营销账号 -->
				<#include "/cart/common/cart_dis.ftl"/> 
			</div>
		</div>
	</div>
		...
		<div class="cart-fix-bottom-wrap" id="js-cart-bottom-handle-wrap">
			<div class="cart-fix-bottom fixedClear">
				<div class="cart-fix-bot-lt-wrap fixedClear">
					<div class="cart-fix-bot-check-wrap fixedClear" onclick="handleCheckAll($(this).find('.list-check-all'), $('#js-cart-dis-list-con-wrap'))">
						<span class="list-check-all " ></span><span>全选</span>
					</div>
					<div class="clear-invalid-data btn-border-disabled" id="js-del-selected-btn" onclick="clearCartData('distri', '', 'del')">删除选中的账号</div>
					<div class="clear-invalid-data btn-border-disabled" id="js-clear-invalid-data" onclick="clearCartData('distri', 3, 'clear')">清空失效账号</div>
					<div class="export-cart-data btn-border-disabled" id="js-export-cart-data" data-id="3">导出选中营销账号</div>
				</div>
...
<script>
    $('#js-cart-tab-wrap').find('li').eq(2).addClass('active'); 
	getCartListData('distri');
</script>
</html>
