	...
	<div class="cart-wrap">
		...
		<div class="cart-tab-con-wrap fixedClear">
			...
			<div class="cart-tab-rt-wrap fixedClear">
				<#include "/cart/common/cart_article_common.ftl"/>
			</div>
		</div>
		<div class="cart-list-con-wrap">
			<ul class="cart-sub-tab-wrap fixedClear" id="js-cart-article-tab-wrap">
				<li data-id="1" class="a-li active">全部</li>
				<li data-id="2" class="a-li">已发布(<span class="" id="js-article-pub-num"></span>)</li>
				<li data-id="3" class="a-li" >未发布(<span class="" id="js-article-un-num"></span>)</li>
			</ul>
			<div class="cart-article-wrap">
				<!-- 作品 -->
				<#include "/cart/common/cart_article.ftl"/> 
			</div>
		</div>
	</div>
	...
	<div class="cart-fix-bottom-wrap" id="js-cart-bottom-handle-wrap">
		<div class="cart-fix-bottom fixedClear">
			<div class="cart-fix-bot-lt-wrap fixedClear">
				<div class="cart-fix-bot-check-wrap fixedClear" onclick="handleCheckAll($(this).find('.list-check-all'), $('#js-cart-article-list-con-wrap'))">
					<span class="list-check-all " ></span><span>全选</span>
				</div>
				<div class="clear-invalid-data btn-border-disabled" id="js-del-selected-btn" onclick="clearCartData('article', '', 'del')">删除选中的作品</div>
				<div class="clear-invalid-data btn-border-disabled" id="js-clear-invalid-data" onclick="clearCartData('article', 2, 'clear')">清空失效作品</div>
				<div class="export-cart-data btn-border-disabled" id="js-export-cart-data" data-id="2">导出选中作品</div>
			</div>
...
<script>
    $('#js-cart-tab-wrap').find('li').eq(1).addClass('active'); 
	getCartListData('article');
</script>
</html>
